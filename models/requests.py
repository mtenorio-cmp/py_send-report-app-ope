...
class UserActivityRequest(BaseModel):
    user_id: Optional[int] = Field(default=None, description="ID del usuario específico")
...
class SalesReportRequest(BaseModel):
    start_date: date = Field(..., description="Fecha de inicio")
    end_date: date = Field(..., description="Fecha de fin")
    product_id: Optional[int] = Field(default=None, description="ID del producto específico")
    region: Optional[str] = Field(default=None, description="Región específica")
    group_by: Optional[str] = Field(default="date", description="Agrupar por: date, product, region")
